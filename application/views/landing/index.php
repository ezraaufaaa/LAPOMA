	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
	  <div class="container">
	    <a class="navbar-brand" href="<?= base_url(); ?>">
	      <img src="<?= base_url('assets/img/img_properties/favicon-text.jpg'); ?>" class="d-inline-block align-top img-fluid img-w-50">
	    </a>
...
<main class="flex-shrink-0">
	<div class="container pb-5">
		...
		<div class="row py-4" id="tentang">
			<div class="col-lg">
				<h4>Tentang</h4>
				<p>LAPOMA adalah website pengaduan pelayanan publik di Kota Malang, sebuah platform yang dirancang untuk memudahkan warga Kota Malang dalam mengomunikasikan tujuan, rekomendasi, keluhan, dan pertanyaan mereka kepada perwakilan pemerintah kota. Petugas yang 
					bertanggung jawab akan menangani pengaduan yang disampaikan melalui LAPORMA, dan pelapor akan menerima salinan temuan penyelesaiannya. Selain petunjuk tentang cara mengajukan pengaduan melalui berbagai saluran, situs web ini juga memberikan saran tentang 
					cara mengisi formulir pengaduan secara akurat. </p>
			</div>
		</div>
